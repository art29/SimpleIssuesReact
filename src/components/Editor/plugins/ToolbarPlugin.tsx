...
/* eslint-disable-next-line react/prop-types */ /* @ts-ignore */
...
/* eslint-disable-next-line react/prop-types */ /* prettier-ignore */ /* @ts-ignore */
function BlockOptionsDropdownList({ editor, blockType, toolbarRef, setShowBlockOptionsDropDown }) {
  ...
  return (
    <div className="editor-dropdown" ref={dropDownRef}>
      ...
      <button className="item" type="button" onClick={formatCode}>
